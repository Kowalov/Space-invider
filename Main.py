...
class Player(Ship):
    ...
    def healthbar(self, window):
        pygame.draw.rect(window, (250, 0, 0), (self.x, self.y + self.ship_img.get_height()+10, self.ship_img.get_width(), 10))
...
def main():
    ...
    def redraw_window():
        ...
        WIN.blit(level_label, (10,20))
        WIN.blit(lives_label, (WIDTH - level_label.get_width() - 10, 20))
